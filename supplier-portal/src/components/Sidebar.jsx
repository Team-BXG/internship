...
import { LayoutDashboard, Users, AlertTriangle, LogOut, Package } from 'lucide-react';
  ...
  return (
    <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col h-screen fixed left-0 top-0 overflow-y-auto z-20 text-slate-300">
      ...
      <div className="p-4 border-t border-slate-800">
         <button className="flex items-center gap-3 px-4 py-2 text-sm font-medium text-slate-400 hover:text-red-400 transition-colors w-full">
